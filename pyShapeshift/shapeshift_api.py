...
class ShapeshiftAPI(object):
    ...
    def __init__(self, request_get_fn, request_post_fn):
        self._get_fn = request_get_fn
        self._post_fn = request_post_fn

    def _shapeshift_get_request(self, url_path):
        """
        Combines the provided url_path with Shapeshift's base url and
        performs a get request.
        """
        url = BASE_URL % url_path
        return self._get_fn(url)

    def _shapeshift_post_request(self, url_path, payload):
        """
    ...
    def get_coins(self):
        ...
        """
        url_path = 'getcoins'
        return self._shapeshift_get_request(url_path)

    def get_rate(self, input_coin, output_coin):
        """
    ...
    def get_deposit_limit(self, input_coin, output_coin):
        """
    ...
    def get_market_info(self, input_coin, output_coin):
        """
    ...
    def get_recent_tx_list(self, max_transactions):
        """
    ...
    def get_time_remaining_on_fixed_tx(self, address):
        """
    ...
    def get_tx_by_api_key(self, api_key):
        """
    ...
    def get_tx_by_address(self, address, api_key):
        """
    ...
    def validate_address(self, address, coin_symbol):
        """
    ...
    def create_normal_tx(self, withdrawal_address, input_coin, output_coin,
                         return_address=None,
        ...
        return self._shapeshift_post_request(url_path, payload)

    def request_email_receipt(self, email, tx_id):
        """
    ...
    def create_fixed_amount_tx(self, amount, withdrawal_address, input_coin, output_coin,
                               return_address=None,
                               destination_tag=None,
                               rs_address=None,
                               api_key=None):
